...
import { IBookStat } from "../src/bookstats/bookstats";
...
describe("Mountebank", () => {
    ...
    it('can create an imposter', async () => {
        ...
        const bookResponse1: IBookStat = { bookId: 1, copiesSold: 2405};
        const bookResponse2: IBookStat = { bookId: 2, copiesSold: 6324};
